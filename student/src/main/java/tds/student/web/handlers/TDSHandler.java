...
public class TDSHandler extends HttpHandlerBase
{
 ...
 /* @ExceptionHandler ({ ReturnStatusException.class })
  @ResponseBody
  public ResponseData<String> handleReturnStatusException (ReturnStatusException rse, HttpServletResponse response) {
     *  response.setStatus (HttpStatusCode.Forbidden); // 403
    return new ResponseData<String> (TDSReplyCode.ReturnStatus.getCode (), rse.getReturnStatus ().getReason (), "");
  }*/
