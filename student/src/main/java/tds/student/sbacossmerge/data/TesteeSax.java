 ...
 * 
 */
public class TesteeSax extends Testee
{
  ...
  {
    // Shiva: only for deserialization reasons. It is required in the
    // serialization but not in deserialization and hence
  ...
  public TesteeSax (TesteeAttributes testeeAttributes) {
  ...
  // The "name" attribute is only required because Javascript seems to be
  // sending that.
  @JsonProperty ("name")
