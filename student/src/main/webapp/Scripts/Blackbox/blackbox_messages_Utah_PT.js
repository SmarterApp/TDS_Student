        ...
        },
        {
            ...
            "m_a": [
                ...
                },
                {
                    ...
                    "t_a": [
                        {
                            "t": "<div class=\"blurb\"><p>Welcome to the Training Test site. You can use this site to take training tests to become familiar with the SAGE System. Some of the questions will require you to select one answer; others may require you to type a short answer, draw a picture, or complete another type of open-ended task. <\/p>",
                            "l": "ENU"
                        }
                    ]
                },
                {
                    ...
                    "t_a": [
                        {
                            "t": "<p>To log in with your student ID (using Name\/SSID):<\/p><ul><li>Uncheck the \"Guest User\" checkbox<\/li><li>Enter your First Name and SSID in the fields above.<\/li><\/ul><p>To log in as a Guest (anonymous user):<\/p><ul><li>Click [Sign In]. <\/li> <\/ul> <p><em>About Guest Sessions:<\/em><br>In a Guest Session, you do not need Test Administrator\/Proctor approval and can take a Training Test using your own settings. To take a Training Test in a session with a Test Administrator\/Proctor, uncheck the “Guest Session” checkbox and enter the Session ID in the fields, then click [Sign In].<\/p><hr \/><p><strong>To learn about the purpose of the SAGE training tests, please visit sageportal.org\/training-tests\/. If you are using the secure browser, you must close it to access the SAGE Portal. <\/strong> <\/p>",
                            "l": "ENU"
                        }
                    ]
                },
                {
                    ...
                    "t_a": [
                        {
                            "t": "<a id=\"btnDiagnostic\" href=\"http:\/\/demo.tds.airast.org\/systemdiagnostic\/pages\/default.aspx?c=Utah_PT&url=https:\/\/utpt.tds.airast.org\/student\">Run Diagnostics<\/a>",
                            "l": "ENU"
                        }
                    ]
                },
